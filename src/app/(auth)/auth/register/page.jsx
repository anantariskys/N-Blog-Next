        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          <div>
            ...
            <input
              ...
              required
              className="mt-1 text-sm block w-full px-3 py-2 border border-gray-300 rounded-md text-black shadow-sm focus:outline-none focus:ring focus:ring-opacity-50"
            />
          </div>
          <div>
            <label
